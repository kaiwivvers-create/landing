...
<body class="bg-stone-50 text-slate-900 font-sans selection:bg-indigo-100 selection:text-indigo-900 overflow-x-hidden">
    ...
    <main id="main-content">
        ...
        <section id="hero"
            ...
            <div
                class="absolute bottom-0 inset-x-0 h-[30rem] bg-gradient-to-t from-[#E0E7FF] via-[#E0E7FF] to-transparent z-10">
            </div>

            <!-- Abstract Background Orbs (Aesthetic Colors) -->
            <div class="absolute inset-0 z-0 opacity-40">
                <div class="absolute -top-24 -left-24 w-96 h-96 bg-blue-400/30 rounded-full blur-3xl animate-pulse">
                </div>
                <div
                    class="absolute top-1/2 -right-24 w-80 h-80 bg-indigo-500/20 rounded-full blur-3xl animate-pulse delay-700">
                </div>
            </div>
        ...
        <section id="camera-section"
            ...
            <div id="camera-container"
                ...
                <div id="camera-trigger"
                    class="relative w-64 h-48 sm:w-80 sm:h-56 bg-slate-800 rounded-xl shadow-[0_30px_60px_-15px_rgba(0,0,0,0.5)] flex flex-col items-center justify-center border-b-[10px] border-slate-900 group-hover:scale-105 transition-transform duration-500">
                    <!-- Top Chrome Bar -->
                    <div class="absolute top-0 inset-x-0 h-4 bg-slate-700 rounded-t-xl border-b border-slate-900/50">
                    </div>

                    <!-- Viewfinder -->
                    <div
                        class="absolute -top-6 left-1/2 -translate-x-1/2 w-20 h-10 bg-slate-800 rounded-t-lg border-x-[8px] border-t-[8px] border-slate-900 flex items-center justify-center">
                        <div class="w-12 h-4 bg-slate-950 rounded shadow-inner"></div>
                    </div>

                    <!-- Shutter Button -->
                    <div
                        class="absolute -top-4 right-8 w-10 h-6 bg-slate-700 rounded-md border-b-4 border-slate-900 active:translate-y-1 transition-transform">
                        <div class="absolute inset-x-2 top-1 h-1 bg-red-500/50 rounded-full animate-pulse"></div>
                    </div>

                    <!-- Flash -->
                    <div
                        class="absolute top-4 left-8 w-12 h-8 bg-slate-200/20 rounded border border-white/10 backdrop-blur-sm">
                    </div>

                    <!-- Lens (The big round part) -->
                    <div
                        class="relative w-32 h-32 sm:w-40 sm:h-40 rounded-full border-[10px] border-slate-900 bg-slate-950 shadow-[inset_0_10px_20px_rgba(0,0,0,0.8)] flex items-center justify-center">
                        <div
                            class="w-24 h-24 sm:w-32 sm:h-32 rounded-full border-4 border-slate-800 bg-gradient-to-br from-slate-700 to-slate-950 flex items-center justify-center overflow-hidden">
                    ...
                    <!-- Branding -->
                    <div
                        class="absolute bottom-4 left-6 text-[10px] font-bold tracking-[0.2em] text-slate-500 uppercase">
                        kaii</div>
                </div>
    ...
    <div id="polaroids-section" class="fixed inset-0" style="display: none; z-index: 9999; pointer-events: auto;">
        ...
        <button id="prev-wave-arrow"
            ...
            style="left: 3rem; top: 50%; transform: translateY(-50%); display: none;">
